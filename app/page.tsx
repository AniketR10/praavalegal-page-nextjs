...
export default function HeroSection() {
  return (
    <main className={`min-h-screen w-full overflow-hidden bg-[#F6F8FD] ${font.className} selection:bg-blue-200`}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute right-0 top-[10%] h-22.5 w-100 rounded-l-full bg-[#E8EDF8] lg:h-27.5 lg:w-125"
        />
        <motion.div
          initial={{ x: '100%', opacity: 0 }}
          animate={{ x: '10%', opacity: 1 }}
          transition={{ duration: 1.8, ease: [0.25, 0.1, 0.25, 1], delay: 0.3 }}
          className="absolute right-0 top-[30%] h-22.5 w-112.5 rounded-l-full bg-[#E8EDF8] lg:h-27.5 lg:w-150"
        />
        <motion.div
          initial={{ x: '100%', opacity: 0 }}
          animate={{ x: '40%', opacity: 1 }}
          transition={{ duration: 1.6, ease: [0.25, 0.1, 0.25, 1], delay: 0.5 }}
          className="absolute right-0 top-[50%] h-22.5 w-87.5 rounded-l-full bg-[#E8EDF8] lg:h-27.5 lg:w-112.5"
        />
        ...
        <motion.div
          ...
          className="absolute left-0 top-[30%] h-20 w-87.5 origin-left rounded-r-full bg-[#E8EDF8] lg:h-25 lg:w-112.5"
        />
        <motion.div
          initial={{ x: '-100%', opacity: 0 }}
          animate={{ x: '-40%', opacity: 1 }}
          transition={{ duration: 1.6, ease: [0.25, 0.1, 0.25, 1], delay: 0.2 }}
          className="absolute left-0 top-[45%] h-20 w-75 rounded-r-full bg-[#E8EDF8] lg:h-25 lg:w-100"
        />
        <motion.div
          initial={{ x: '-100%', opacity: 0 }}
          animate={{ x: '-20%', opacity: 1 }}
          transition={{ duration: 1.9, ease: [0.25, 0.1, 0.25, 1], delay: 0.4 }}
          className="absolute left-0 bottom-[15%] h-22.5 w-112.5 rounded-r-full bg-[#E8EDF8] lg:h-30 lg:w-150"
        />
      </div>
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-20 lg:grid-cols-2 lg:gap-8 lg:py-28">
        ...
        <div className="relative z-20 flex flex-col gap-6 text-center lg:-mt-12 lg:text-left">
          <motion.h1 
            ...
            className="text-5xl font-light leading-[1.15] tracking-tight text-[#828CAE] lg:whitespace-nowrap lg:text-[4.2rem]"
          >
            A single platform to <br />
            <span className="font-semibold text-[#6A759B]">manage</span> every part&nbsp;of <br />
            your <span className="font-semibold text-[#6A759B]">legal work</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-base leading-relaxed text-[#5C6BFF] lg:text-[1.1rem]"
          >
        ...
        <div className="relative z-30 h-150 w-full perspective-1000 lg:h-175 lg:-ml-16 lg:mt-8">
          ...
          >
            ...
            <span className="text-xl font-semibold tracking-wide a">Billing</span>
          </FloatingCard>
         ...
         <FloatingCard 
          ...
          >
            ...
            <div className="relative mt-3 shrink-0">
              <div className="h-10 w-10 overflow-hidden rounded-full border-2 border-transparent bg-slate-200">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix&backgroundColor=e2e8f0" alt="Avatar" />
              </div>
              <span className="absolute bottom-0 right-0 block h-2.5 w-2.5 rounded-full bg-orange-500 ring-2 ring-[#9BA4E5]" />
            </div>
            
            <div className="flex flex-col text-xs">
              <span className="font-bold text-[#201C3A]">John Doe - Portal</span>
              <p className="mt-0.5 text-xs leading-snug text-[#5E648B]">
                Hey! Could you please review a<br/> document for me?
              </p>
              <span className="mt-1 text-[10px] text-[#7E849A]">MAT-2233 - 2 h ago</span>
            </div>
          </FloatingCard>
